  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: SingleChildScrollView(
                ...
                child: Row(
                    ...
                    children: <Widget>[
                      ...
                      CachedNetworkImage(
                          ...
                          placeholder: (context, url) => Center(child: SpinKitThreeBounce(color: black, size: 5.0)),
                                    ...
                                    child: Card(
                                        ...
                                        child: InkWell(
                                            ...
                                            child: Column(
                                              ...
                                              children: <Widget>[
                                                CachedNetworkImage(
                                                  imageUrl: productProvider.products[index].image.toString(),
                                                  imageBuilder: (context, imageProvider) => Container(
          ...
          Container(
              height: 140.0,
              margin: EdgeInsets.only(left: 16.0, top: 110.0, right: 16.0),
