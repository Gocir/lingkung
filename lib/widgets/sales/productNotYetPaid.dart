...
class ProductNotYetPaid extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    final userProvider = Provider.of<UserProvider>(context);
    final orderProvider = Provider.of<OrderProvider>(context);
    orderProvider.loadSalesOwnerNYP(userProvider.user.uid);
    return (orderProvider.salesOwnerNYP.isNotEmpty)
        ? ListView.builder(
            ...
            itemBuilder: (_, index) {
              OrderModel _order = orderProvider.salesOwnerNYP[index];
