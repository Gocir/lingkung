...
class NotYetPaidHistoryProduct extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    orderProvider.loadOrderByStatus("Belum Bayar");
    return (orderProvider.orderByStatus.isNotEmpty)
        ? ListView.builder(
            ...
            itemBuilder: (_, index) {
              ...
              return (_order.listProduct.length == 0) ? Loading() : InkWell(
                onTap: () {
                  // Navigator.push(
                  //     context,
                  //     MaterialPageRoute(
                          ...
                          children: <Widget>[
                            Row(
                                ...
                                children: <Widget>[
                                  ...
                                  SizedBox(width: 5.0),
                                  CustomText(text: '${userProvider.userById?.name}', weight: FontWeight.w600)
                                ]),
                            Divider(),
                            ...
                            Row(
                              ...
                              children: <Widget>[
                                CustomText(text: _order.listProduct.length.toString() + '  Produk', size: 10.0),
                                RichText(
