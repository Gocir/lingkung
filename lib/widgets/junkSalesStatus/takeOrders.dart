        ...
        child: Stack(
          ...
          children: <Widget>[
            Padding(
              ...
              child: Image.asset('assets/images/verifyAccount.png'),
            ),
            Container(
                            ...
                            child: RichText(
                              text: TextSpan(
                                children: [
                                  ...
                                  TextSpan(
                                    text:
                                        'Saatnya menimbang sampahmu. Pastikan hitungannya tepat ya...',
                                    style: TextStyle(
                                      color: black,
                                      fontFamily: 'Poppins',
                                      fontSize: 12.0,
