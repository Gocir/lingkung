...
class DeliverOrders extends StatefulWidget {
  ...
  DeliverOrders({this.junkSalesId});
  @override
        ...
        child: Stack(
          ...
          children: <Widget>[
            Padding(
              ...
              child: Image.asset('assets/images/savearth.png'),
            ),
                            ...
                            child: RichText(
                              text: TextSpan(
                                children: [
                                  ...
                                  TextSpan(
                                    text:
                                        'Sekarang sampahmu sedang diantar ke tempat tujuan yang kamu pilih ya...',
                                    style: TextStyle(
                                      color: black,
                                      fontFamily: 'Poppins',
                                      fontSize: 12.0,
                          ...
                          ListTile(
                            ...
                            leading: CustomText(
                              text: NumberFormat.currency(
                                          ...
                                          decimalDigits: 0)
                                      .format(
                                          junkSalesProvider.listTrash[0].weight) +
                                  ' Kg',
